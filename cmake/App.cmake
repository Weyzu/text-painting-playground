...
ExternalProject_Add(UltralightSDK
  URL https://f000.backblazeb2.com/file/multimornion-deps/ultralight-sdk-latest-${PLATFORM}-x64.7z
  URL "${SDK_URL}"
  SOURCE_DIR "${SDK_ROOT}"
  BUILD_IN_SOURCE 1
  CONFIGURE_COMMAND ""
...
MACRO(ADD_APP source_list)
  ...
  if (APPLE)
    link_libraries(UltralightCore AppCore Ultralight WebCore ${CocoaLib})
  else ()
